...
public class Chapter2 extends JPanel implements Runnable, KeyListener {
    // --- Game mode ---
    ...
    // --- FILES FOR EACH MODE ---
    private static final String HIGH_SCORE_FILE_PVP = "highscore_pvp.txt";
    private static final String HIGH_SCORE_FILE_PVC = "highscore_pvc.txt";
    ...
    public Chapter2() {
        loadHighScores(); // Load correct high scores depending on mode
    ...
    private void saveHighScores() {
        String fileName = vsComputer ? HIGH_SCORE_FILE_PVC : HIGH_SCORE_FILE_PVP;
    ...
    public static void main(String[] args) {
        ...
        frame.setContentPane(new Chapter2());
        frame.pack();
